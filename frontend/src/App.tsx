...
const Consultation = lazy(() =>
  withTimeout(import("./pages/consultationPage"), 20000),
);
const NotFound = lazy(() => withTimeout(import("./pages/notFound"), 20000));
const TriageAlert = lazy(() =>
  withTimeout(import("./pages/triageAlert"), 20000),
);
const Profile = lazy(() =>
  withTimeout(import("./pages/patientProfile"), 20000),
);
const PatientHome = lazy(() =>
  withTimeout(import("./pages/patientHome"), 20000),
);
const PatientLocation = lazy(() =>
  withTimeout(import("./pages/patientLocation"), 20000),
);
...
const Interview = lazy(() =>
  withTimeout(import("./components/common/interview"), 20000),
);
const Documents = lazy(() =>
  withTimeout(import("./components/common/documents"), 20000),
);
...
export default function App() {
  ...
  return (
    <RouteBoundary>
      ...
      >
        <Routes>
          <Route path="/lab" element={<LabWorkflow />} />
          <Route
            path="/patient/home"
            element={
              <ProtectedRoute>
